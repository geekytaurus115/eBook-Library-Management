...
<html lang="en">
  <head>
    ...
    <title>eBook Byte | Member Feedback</title>
  </head>
  <style>
    body{
...
.boxtwo{
  background-image: url("images/showFed_img.jpg");
  background-repeat: no-repeat;
...
<nav class="navbar navbar-expand-lg  navbar-dark  bg-dark">
          ...
          <li class="nav-item ">
           ...
           <div style="margin-left: 10px;">
             <li class="nav-item active">
                <a class="nav-link" href="showFeedback.php" 
                   style="background-color:darkblue;border-radius:12px">Member Feedback</a>
             </li>
           </div>
    ...
    <div class="container" id="title">
     ...
     <table  style =" font-size:16pt"  align="center" width="100%" height="70%">
          ...
          <td align="center"><b><i><mark style="color:white;background-color:maroon;
           border-radius:5px">Member Feedback</mark></i></b></td>
        </tr>
      </table>
 ...
 <br>
  <div class="boxtwo"
   style="border:solid 1px #CF0403;border-radius: 10px; width:84%; height:450px; 
   margin-left:115px;margin-top:10px;background-color:white">
...
<?php
 //----------------------------if search-------------------------------------
    if(isset($_POST['submit']))
		{
			$p=mysqli_query($conn,"SELECT * from `comment` where name like '%$_POST[search]%' ");

			if(mysqli_num_rows($p)==0)
			{
        echo "<h3 style='margin-top:100px;margin-left:300px; color:darkred;'>
                  Sorry! Feedback not found  :(</h3><br>
                  <p style='margin-top:-30px;margin-left:387px; color:blue;'>
                  Search again..</p>";
			}
			else
			{
		  echo "<table class='table table-bordered table-hover fixed' >";
			echo "<tr style='background-color:#6bd6b9e6;'>";
              ...
              echo "<th>";?>
                 <h6 style="color:black;"><strong><i><?php echo "No.";?>
                 </i></strong></h6> 
        <?php echo "</th>";
              echo "<th>";?>
                 <h6 style="color:black;"><strong><i><?php echo "Name";?>
                 </i></strong></h6> 
        <?php echo "</th>";
              echo "<th>";?>
                  <h6 style="color:black;"><strong><i><?php echo "Email Id";?>
                  </i></strong></h6> 
        <?php echo "</th>";
              echo "<th><div style='width:250px;overflow:hidden'>";?>
                  <h6 style="color:black;"><strong><i><?php echo "Comment";?>
                  </i></strong></h6> 
        <?php echo "</div></th>";
              echo "<th colspan='2'>";?>
        ...
        echo "<td><div style='width:250px;overflow:hidden'>"; 
                     echo $row['comment']; echo "</div></td>";
        echo "<td>";
    ?>      
        <form action="" method="POST" align="center">
              <input type="hidden" value="<?php echo $row['email']?>" name="email">                 
              <input type="submit" value="Approve"  name="submit1"
                     style="border-radius:5px; color:white;
                            background-color:rgb(12 106 15);">
        </form>
    <?php
        echo "</td>";
        echo "<td>";
    ?>      
        <form action="" method="POST" align="center">
             ...
             <input type="submit" value="Decline"  name="submit2"
                    style="border-radius:5px; color:white;
...
<!-- ---------------------php code for creating session for approve--------------------------- -->
<?php
     if(isset($_POST['submit2']))
     {
      mysqli_query($conn,"DELETE from comment where comment = '$_POST[comment]'; ");
      ?>
       
       <!-- <div>
      <div class="alert alert-success alert-dismissible fade show" role="alert">
      <h3 style="text-align:center;"><strong>Comment deleted successfully!</strong></h3> 
