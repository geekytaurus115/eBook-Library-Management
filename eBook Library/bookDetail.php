...
<nav class="navbar navbar-expand-lg  navbar-dark  bg-dark">
          ...
          <li class="nav-item">
           ...
           <div style="margin-left: 10px;">
             <li class="nav-item active">
                <a class="nav-link" href="bookDetail.php"
                style="background-color:darkblue;border-radius:12px;">Book Details</a>
             </li>
           </div>
           <div style="margin-left: 10px;">
             <li class="nav-item">
    ...
    <div class="container">
     ...
     <table  style =" font-size:16pt"  align="center" width="100%" height="70%">
          ...
          <td align="center"><b><i><mark style="color:white;background-color:maroon; 
              border-radius:5px">List of Books</mark></i></b></td>
        </tr>
      </table>
 ...
 <br>
  <div class="boxtwo" style="border:solid 1px #CF0403;
       border-radius: 10px; width:1400px; height:450px; margin-left:68px;margin-top:10px;
       background-color:white">
...
<!-- 
    ...
    <div style="margin-left:51px;margin-top:7px;">   
    <div class="scroll">  
	<?php
    ...
    if(isset($_POST['submit']))
		{
			...
			{
        echo "<h3 style='margin-top:100px;margin-left:470px; color:darkred;'>
                  Sorry! Book not found  :(</h3><br>
                  <p style='margin-top:-30px;margin-left:530px; color:blue;'>
                  Search again..</p>";
			}
			else
			{
		  echo "<table class='table table-bordered table-hover' >";
			echo "<tr  style='background-color:#6db6b9e6;'>";
                //Table header
				echo "<th>";?>
                <h6 style="color:black;"><strong><?php echo "Id";?>
                </strong></h6> 
           <?php echo "</th>";
                echo "<th>";?>
                <h6 style="color:black;"><strong><?php echo "Book Name";?>
                </strong></h6> 
           <?php echo "</th>";
                 echo "<th>";?>
                 <h6 style="color:black;"><strong><?php echo "Authors Name";?>
                 </strong></h6> 
           <?php echo "</th>";
                 echo "<th>";?>
                 <h6 style="color:black;"><strong><?php echo "Edition";?>
                 </strong></h6> 
           <?php echo "</th>";
                 echo "<th>";?>
                 <h6 style="color:black;"><strong><?php echo "Status";?>
                 </strong></h6> 
           <?php echo "</th>";
                 echo "<th>";?>
                 <h6 style="color:black;"><strong><?php echo "No. of Copies";?>
                 </strong></h6> 
           <?php echo "</th>";
                 echo "<th>";?>
                 <h6 style="color:black;"><strong><?php echo "Department";?>
                 </strong></h6> 
           <?php echo "</th>";
                 echo "<th>";?>
                 <h6 style="color:black;"><strong><?php echo "File Name";?>
                 </strong></h6> 
           <?php echo "</th>";
                 echo "<th>";?>
                 <h6 style="color:black;"><strong><?php echo "Cover img_name";?>
                 </strong></h6> 
           <?php echo "</th>";
                 echo "<th colspan='2'>";?>
        ...
        echo "<td>"; echo $row['cover']; echo "</td>";
        echo "<td>";
  ?>      
...
<?php
        ...
        echo "<td>";
  ?>      
        <form action="dltBook.php" method="POST">
...
//-----------------------------if not search------------------------------
 ...
 ?>      
        <form action="updateBook.php" method="POST">
              ...
              <input type="hidden" value="<?php echo $row['edition']?>" name="edition">
              <input type="hidden" value="<?php echo $row['copies']?>" name="copies">
