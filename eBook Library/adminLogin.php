...
<html lang="en">
  <head>
    ...
    <title>eBook Byte | Admin Login</title>
  </head>
  <style>
 body{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <table  style =" font-size:16pt"  align="center" width="100%" height="100%" >
          ...
          <td align="center"><b><i><mark style="color:white;background-color:maroon;
           border-radius:5px">Admin Login Portal</mark></i></b></td>
        </tr>
    </table>
   ...
   <br>
    ...
    <form method="post" action="">
      <div  class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:73.5%; height:360px; margin-left:13%;margin-top:15px;background-color:white">
        ...
        <fieldset align="center" style="  background:rgba(0,0,0,0.38);color:blue; margin-top:60px" class="five" class="one">
          <div class="boxfour" >
            <h3 style="color:white;text-align:center;;padding-top:1px;padding-bottom: 1px;background:#660000;border-radius:12px;
        ...
        <table style="font-size:16pt;width:300px;height:50px;margin-right:45px;" align="Right">
          ...
          <tr>
            ...
            <td><input type="text" name="email" placeholder="username"  style="color:red"></td>
          </tr>
          ...
          <p style="color:red;font-weight:bold;font-size:17px;text-align:center;background:rgba(255, 255, 255, 0.8)">
          </p>
...
<?php
    if(isset($_POST['submit']))
    {
      ...
      $res=mysqli_query($conn,"SELECT * FROM `admin` WHERE
          email='$_POST[email]' && password='admin123';");
