...
<html lang="en">
  <head>
    ...
    <title>eBook Byte | Delete Member</title>
  </head>
  <style>
    body{
...
.boxtwo{
  background-image: url("images/dltMem_img.jpg");
  background-repeat: no-repeat;
...
<nav class="navbar navbar-expand-lg  navbar-dark  bg-dark">
          ...
          <li>
           ...
           <div style="margin-left: 10px;">
             <li class="nav-item active">
                <a class="nav-link" href="dltMem.php"
                style="background-color:darkblue;border-radius:12px;">Delete Member</a>
             </li>
           </div>
   ...
   <br>
    ...
    <div class="container">
     ...
     <table  style =" font-size:16pt"  align="center" width="100%" height="70%">
          ...
          border-radius:5px">Delete Member</mark></i></b></td>
        </tr>
      </table>
 ...
 <form method="post" action="">
  ...
  <table style= "color:#FFFFFF;padding-top:10px;">
      ...
      <br>
      <tr>
    <td style="width:250px;text-align:center;">Username&nbsp;&nbsp;&nbsp;:</td>
...
if(isset($_POST['submit']))
{
  ...
  ?>
          ...
          <h3 style="text-align:center;"><strong>Wrong Username!</strong></h3>
          <h5 style="text-align:center;">Please enter a valid Username..</h5>
...
<?php
    ...
    mysqli_query($conn,"DELETE from member where email = '$_POST[email]'; ");
    ?>
      
      <div style="margin-left:350px;">
              <div class="alert alert-success alert-dismissible fade show" role="alert" style="margin-top:-500px;
                        width:800px;height:100px;">
                  <h3 style="text-align:center;"><strong>Member deleted successfully!</strong></h3>
                   <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
                  </button>
              </div>
