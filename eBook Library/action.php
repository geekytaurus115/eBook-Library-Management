      ...
      <ul class="navbar-nav mr-auto">
        ...
        <div style="margin-left: 40px;">
          <li class="nav-item active">
            <a class="nav-link" href="action.php" style="background-color:darkblue;border-radius:12px">Book Details</a>
          </li>
        </div>
           <div style="margin-left: 40px;">
             <li class="nav-item">
...
<div class="box">
  ...
  <br><br>
   <div class="container">
    ...
    style="border:solid 1px black;border-radius: 10px; width:100%; height:380px;
    margin-left:0%;margin-top:10px;background-color:white">  
    <table class="bookInfo" style="width: 800px;height:300px;margin-top:45px;">
        <tr>

        
<!-- --------------------php code for showing book details------------------------------ -->
...
<?php
    ...
    ?>
     ...
     <td>
           <?php echo '<img src="uploadedFiles/'.$s.'" alt="'.$row['name'].'"
                   style="width:210px;height:260px;margin-left:35px;margin-top:5px;">'; ?>
      ...
      ?>
            <table style="margin-left: 40px;margin-top:20px;">
                <tr>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      :</i></strong></h5></td>
                      <?php echo "<td><strong><p style='color:darkblue;font-size:15pt;'>";
                     echo $row['name']; echo "</p></strong></td>";?>
                </tr>
                <tr>
                    <td><h5><strong><i> Authors Name :&nbsp;</i></strong></h5></td>
                    <?php echo "<td><strong><p style='color:darkblue;font-size:15pt;'>";
                     echo $row['authors']; echo "</p></strong></td>";?>
                </tr>
                <tr>
                   <td><h5><strong><i> Edition&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   &nbsp;&nbsp;&nbsp;&nbsp;
                      :</i></strong></h5></td>
                      <?php echo "<td><strong><p style='color:darkblue;font-size:15pt;'>";
                     echo $row['edition']; echo "</p></strong></td>";?>
                </tr>
                <tr>
                    <td><h5><strong><i> Status &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      :</i></strong></h5></td>
                      <?php echo "<td><strong><p style='color:darkblue;font-size:15pt;'>";
                     echo $row['status']; echo "</p></strong></td>";?>
                </tr>
                <tr>
                    <td><h5><strong><i> Department &nbsp;&nbsp;&nbsp;&nbsp;
                      :</i></strong></h5></td>
                    <?php echo "<td><strong><p style='color:darkblue;font-size:15pt;'>";
                     echo $row['department']; echo "</p></strong></td>";?>
                </tr>
                
                  
                 
            </table>
            <div  style="margin-left:123px;margin-top:5px;">
                     <!-- <input type="submit" value="Read"
                       style="border-radius:5px ; color:white;
                       background-color:green;border: solid 1px black;">&nbsp;&nbsp; -->

                       <button type="button" style="border-radius:5px ; color:white;
                       background-color:green;border: solid 1px black; "><a style="color:white;"
                       href="uploadedFiles/trending1.pdf" target="_blank">
                       Read</a></button>
                       &nbsp;&nbsp;

                      
                     <!-- <input type="submit" value="Download"  name="submit"
                     style="border-radius:5px; color:white;border: solid 1px black;
                       background-color:#FF8C00;"> -->


                       <button type="button" style="border-radius:5px ; color:white;
                       background-color:#FF8C00;border: solid 1px black; "><a style="color:white;"
                       href="download.php?file=<?php echo "$fname"?>" target="_blank">
                       Download</a></button>
                    </div>
